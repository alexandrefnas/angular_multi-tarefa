...
export default {
  ...
  assets: {
    ...
    'teste/index.html': {size: 40823, hash: 'd63731d1674b1df1d654376363fb3aa1f2e29c03537f1effd7b56cc845837343', text: () => import('./assets-chunks/teste_index_html.mjs').then(m => m.default)},
